...
int SHA256_Init(SHA256_CTX *c)
{
    ...
    qe_cleanse(c, sizeof(SHA256_CTX)); /* Security consideration */
...
static int SHA256_ProcessBlock(SHA256_CTX *ctx, const void *block)
{
    ...
    SHA256_PrepareScheduleWord(static_cast<const uint32_t*>(block), W);
...
int SHA224_Final(unsigned char *md, SHA256_CTX *c)
{
    ...
    qe_cleanse(&sha256_md, sizeof(sha256_md)); /* Security consideration */
